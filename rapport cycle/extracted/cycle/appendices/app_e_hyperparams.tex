...
\section*{E.1 — Grid Search YOLOv11 (7 configurations)}

\begin{table}[H]
\centering
\caption{Résultats du Grid Search YOLOv11 (7 configurations d'hyperparamètres)}
\label{tab:gs_yolo}
\resizebox{\textwidth}{!}{%
...
L'augmentation étendue (mosaic + flip + HSV + rotation ±15$^{\circ}$ + blur) apporte
